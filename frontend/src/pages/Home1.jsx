...
function Home() {
  ...
  const handleGenerateFlashcards = async () => {
    ...
    try {
      ...
      setResult(response.data.data);none
      ...
      <div className="flex flex-col items-center justify-center min-h-screen w-full bg-gray-950 px-6 overflow-hidden">
        ...
        <div className="relative w-full max-w-3xl mb-4">
          <textarea
            ...
            className="w-full h-24 p-4 pr-14 rounded-xl bg-stone-900 text-white resize-none focus:outline- focus:ring-2 focus:ring-sky-500 hover:bg-stone-800/80 transition-all duration-300 placeholder-gray-500"
          />
          <button
